...
export class Fire extends Mesh {
  constructor(geometry, options, scene, cameraInstance) {
    ...
    this.expansion =
      options.expansion === undefined ? -0.25 : options.expansion;
    ...
    // --- --- --- --- --- line 148 in Fire_es5.js

    this.field0 = new WebGLRenderTarget(
      this.textureWidth,
      this.textureHeight,
      this.parameters
    );
    ...
    this.field1 = new WebGLRenderTarget(
      this.textureWidth,
      this.textureHeight,
      this.parameters
    );
    ...
    if (!isPowerOfTwo(this.textureWidth) || !isPowerOfTwo(this.textureHeight)) {
    ...
    // Corresponds to line 181 in Fire_es5.js
    this.orthoCamera.position.z = 1;

    this.fieldGeometry = new PlaneBufferGeometry(
      this.textureWidth,
      this.textureHeight
    );
  ...
  configShaders(dt) {
    ...
    this.driftMaterial.uniforms["airSpeed"].value =
      dt * this.airSpeed * 0.001 * this.textureHeight;
